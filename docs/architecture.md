...
| `publish-python.yml` | GitHub Release published | builds Python artifacts, then publishes `tstring-html-bindings`, `html-tstring`, and `thtml-tstring` via separate Trusted Publisher environments |
